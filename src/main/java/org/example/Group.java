...
class GroupCommand {
    public void addMember(String line, Database database) {
        ...
        System.out.println(museum_code + " ## " + timetable + " ## " + "new member: " + "surname=" + person.getSurname() + ", " + "name=" + person.getName() + ", role=" + role + ", age=" + person.getAge() + ", email=" + person.getEmail() + ", school=" + person.getSchool() + "," + name_ocupation + "=" + person.getExperience());

    }

    public void addGuide(String line, Database database) {
        String[] parts = line.split("\\|");
        String surname = parts[1];
        String name = parts[2];
        String profession = parts[3];
        ...
        if (ok_guide == 0) {
            ...
            System.out.println(museum_code + " ## " + timetable + " ## " + "new guide: " + "surname=" + guide.getSurname() + ", " + "name=" + guide.getName() + ", role=" + role + ", age=" + guide.getAge() + ", email=" + guide.getEmail() + ", school=" + guide.getSchool() + ", " + name_ocupation +"=" + guide.getExperience());
    ...
    public void removeMember(String line, Database database) {
        String[] parts = line.split("\\|");
        String surname = parts[1];
        String name = parts[2];
        String profession = parts[3];
        ...
        if (group_found != null && group_found.getMembers() != null) {
            ...
            if (remove_person != null) {
                ...
                System.out.println(museum_code + " ## " + timetable + " ## " + "removed member: " + "surname=" + remove_person.getSurname() + ", " + "name=" + remove_person.getName() + ", role=" + role + ", age=" + remove_person.getAge() + ", email=" + remove_person.getEmail() + ", school=" + remove_person.getSchool() + ", " + name_ocupation +"=" + remove_person.getExperience());
            }
        }
